...
var orm = {
    ...
    selectItemsOwned: function(cb){
      var queryString = "SELECT P.LOCATION, P.DESCRIPTION, C.NAME CATEGORY_NAME, IM.PATH IMAGE_PATH, IM.NAME IMAGE_NAME, P.CREATEDAT, P.OCCUPIED_DATE, P.OCCUPIED_PERIOD FROM PLACES P INNER JOIN CATEGORIES C ON (C.ID = P.CATEGORY_ID) LEFT JOIN IMAGES IM ON (IM.ID = P.IMAGE_ID) WHERE OWNER_ID = 1 ORDER BY P.OCCUPIED_DATE";
